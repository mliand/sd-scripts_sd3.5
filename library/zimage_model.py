    ...
    def forward(
        ...
        if self.training and self.gradient_checkpointing:
            ...
            return self._forward(
                x, freqs_cis, adaln_input, attn_params, repulsion_config, repulsion_step_idx, x_seq_len, cap_mask
            )
