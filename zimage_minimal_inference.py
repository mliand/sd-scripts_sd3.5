...
LAYERBIND_PHASE2_QUERY_ALPHA_THRESHOLD = 0.20
LAYERBIND_PHASE2_QUERY_MIN_FRACTION = 0.35
            ...
            for region_state, region_condition in zip(region_states, region_conditions):
                ...
                if include_query_in_kv:
                    ...
                    if background_tokens.shape[1] > 0:
                        ...
                        reverse_indices = region_state.get("reverse_adaptation_indices", local_context_indices)
